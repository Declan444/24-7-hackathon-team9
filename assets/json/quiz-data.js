const jsonData = [
  ...
  },
  {
    ...
    prompt: "This Pride Flag was first shown in 2021, designed by artist Valentino Vecchietti. What does the arrow on the left represent?",
    choices: [
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "c", content: "Forming sexual attraction only after establishing an emotional connection with someone" },
      { id: "d", content: "Feeling attraction to people of more than one gender" }
    ],
    answer: "c",
  },
  {
  ...
  },
  {
    ...
    prompt: "This is the Pansexual Pride flag. Which of these is a popular saying in the Pansexual Community when talking about how they feel attraction for other people?",
    choices: [
  ...
  },
  {
    ...
    prompt: "This is the Gender Fluid Pride Flag. But which of these novels with a Gender Fluid protagonist came out first?",
    choices: [
  ...
  {
    id: "14",
    prompt: "Which was the first country in the world to legalize same-sex marriage?",
    choices: [
      { id: "a", content: "Japan" },
  ...
  {
    id: "18",
    prompt: "Which of the following is the first-ever openly gay character in the Marvel comics universe?",
    choices: [
  ...
  {
    id: "19",
    prompt: "São Paulo Gay Pride Parade was listed by Guinness World Records as the worlds largest Pride Parade in 2009. How many people attended that year?",
    choices: [
  ...
  {
    id: "20",
    prompt: "Which early computer scientist was charged with 'Gross Indecency' for being Homosexual?",
    choices: [
